...
function getDefaultAgentSeeds(): (Partial<AgentRow> & { id: string })[] {
  return [
    ...
    { id: "cfto", name: "Chris", title: "CFTO", emoji: "📈", model: "Sonnet 4", department: "Revenue", status: "active", description: "Chris Vermeulen — CFTO owning all financial tools and products.", reports_to: "coo", direct_reports: [], files: {} },
