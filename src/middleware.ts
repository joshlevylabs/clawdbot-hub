...
const publicPaths = ['/login', '/forgot-password', '/reset-password', '/api/auth/login', '/api/auth/logout', '/api/auth/forgot-password', '/api/auth/reset-password', '/api/markets', '/api/price-history', '/api/faith/', '/api/agents'];
