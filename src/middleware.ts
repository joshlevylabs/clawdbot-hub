...
const publicPaths = ['/login', '/forgot-password', '/reset-password', '/api/auth/', '/api/markets', '/api/price-history', '/api/faith/', '/api/agents', '/api/trading/signals', '/api/trading/agent-snapshots', '/api/trading/agent-portfolios', '/api/paper-trading', '/api/trading/competition', '/legal'];
