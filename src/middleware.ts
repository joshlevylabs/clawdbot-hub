...
const publicPaths = ['/login', '/api/auth/login', '/api/auth/logout', '/api/compass', '/api/markets', '/api/price-history', '/api/faith/guide', '/api/faith/watt-usage', '/api/faith/guide/conversations'];
